...
import com.ne0fhyklabs.freeflight.controllers.MyoGlassService;
...
public class ControlDroneActivity extends FragmentActivity implements
    ...
    private final ControlDroneActivity that = this;
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mService.setControlDroneActivity(that);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindService(new Intent(this, MyoGlassService.class), mServiceConnection, Context.BIND_AUTO_CREATE);
